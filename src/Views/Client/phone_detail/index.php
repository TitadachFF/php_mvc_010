        ...
        <div class="col-span-4 mt-6">
            ...
            <div class="flex flex-col">
                <div class="flex items-center mt-7">
                    ...
                    <span class="text-sm mr-6 mt-3">ขนาดความจุ</span>
                ...
                <div class="flex items-center justify-start mt-2">
                    <span class="text-sm mr-4 mt-3">เลือกสี</span>
            ...
            <div class="flex flex-col">
                <span class="mt-7 text-lg">ราคา</span>
                <div class="flex items-center mt-2">
                    ...
                    <span class="text-xs px-3 py-1 bg-[rgba(196,196,196,0.4)]">ส่วนลด 0%</span>
                </div>
            </div>
